	...
	<div id="total">
		<div id="center">
			...
			<form action="insert2" id="form"
				  ...
				  <!-- method="post"와 ecntype을 맞추어 주어야합 -->
				<span class="input-group-text">TITLE</span> <input type="text"
					class="form-control input-sm" name="title" placeholder="title" value="서울의 봄"><br>
				...
				<input type="text"
					...
					placeholder="genre" value="시대물"><br>
				...
				<input
					...
					value="https://namu.wiki/w/%EC%84%9C%EC%9A%B8%EC%9D%98%20%EB%B4%84(%EC%98%81%ED%99%94)"><br>
